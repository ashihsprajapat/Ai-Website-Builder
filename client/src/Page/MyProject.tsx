        ...
        {loading ? (
          ...
          <div className="min-h-[80vh] py-10">
            <div className="flex items-center justify-between">
              ...
              <button
                className="flex items-center justify-center gap-2 boarder text-sm bg-indigo-700 hover:bg-indigo-500 
              px-3 py-1.5 rounded"
                onClick={() => navigate("/")}
              >
                <PlusIcon /> Create New
                  ...
                  <div className="p-4 text-white ng-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors ">
                    ...
                    >
                      ...
                      <div className="flex gap-3  ">
                        ...
                        <button className="text-white bg-gray-800   px-2 py-1 text-sm rounded-sm ">
                          Open
                        </button>
                      </div>
                    </div>
