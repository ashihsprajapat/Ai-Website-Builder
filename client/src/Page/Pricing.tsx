    ...
    <>
      <div className=" w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh] ">
        <div className=" text-center mt-16 ">
          <h2 className="font-medium text-gray-100 text-3xl ">Choose your plan</h2>
        ...
        <p className="text-center mt-10 text-sm max-w-md mx-auto text-white/60 font-light "> Project
          <span className="text-white"> Creation / Revision  </span>
          Consume <span className="text-white">5 Credits</span>. You can  purchase more credits
          to credits to create more projects. </p>
        <Footer />
      </div></>
  );
};